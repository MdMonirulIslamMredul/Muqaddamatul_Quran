        ...
        <div class="col-lg-12">
            ...
            <div class="card border shadow-sm">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center border-bottom">
                    <div>
                        <h4 class="card-title mb-0 fw-bold" style="color: #212529;">Edit Admission Guideline Section</h4>
                        <small class="text-muted">Modify multi-language admission details, fees, process, rules, and point checklists</small>
                    </div>
                    <div>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('admission-guidelines.update', $guideline->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="tab-content" id="languageTabContent">
                            ...
                            <div class="tab-pane fade show active" id="lang-en" role="tabpanel" aria-labelledby="lang-en-tab">
                                <div class="alert alert-info py-2 mb-3">
                                    <small><i class="fa fa-info-circle me-1"></i> Editing content in <strong>English</strong></small>
                                </div>

                                <div class="mb-4">
                                    <label class="form-label fw-semibold">Section Title (English) <span class="text-danger">*</span></label>
                                    <input type="text" name="section_title" class="form-control @error('section_title') is-invalid @enderror" value="{{ old('section_title', $guideline->section_title) }}" placeholder="e.g. Admission Requirements" required>
                                    @error('section_title')
                                ...
                                <div class="row g-3 mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <textarea id="details_en" name="details" class="form-control rich-editor" rows="5">{!! old('details', $guideline->details) !!}</textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                        ...
                                        <textarea id="process_en" name="process" class="form-control rich-editor" rows="5">{!! old('process', $guideline->process) !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row g-3 mb-4">
                                    <div class="col-md-4">
                                        ...
                                        <textarea id="admission_fees_en" name="admission_fees" class="form-control rich-editor" rows="5">{!! old('admission_fees', $guideline->admission_fees) !!}</textarea>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                        ...
                                        <textarea id="monthly_fees_en" name="monthly_fees" class="form-control rich-editor" rows="5">{!! old('monthly_fees', $guideline->monthly_fees) !!}</textarea>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                        ...
                                        <textarea id="others_fees_en" name="others_fees" class="form-control rich-editor" rows="5">{!! old('others_fees', $guideline->others_fees) !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea id="payment_rules_en" name="payment_rules" class="form-control rich-editor" rows="4">{!! old('payment_rules', $guideline->payment_rules) !!}</textarea>
                                </div>
                                ...
                                <div id="points-container-en" class="mb-4">
                                    @php $enPoints = old('points', is_array($guideline->points) ? $guideline->points : []); @endphp
                                    @if(!empty($enPoints))
                                        @foreach($enPoints as $index => $point)
                                            <div class="point-row input-group mb-2">
                                                <span class="input-group-text bg-light fw-bold point-index">{{ $index + 1 }}</span>
                                                <input type="text" name="points[]" class="form-control" value="{{ $point }}" placeholder="Enter guideline instruction in English...">
                            ...
                            <div class="tab-pane fade" id="lang-bn" role="tabpanel" aria-labelledby="lang-bn-tab">
                                <div class="alert alert-success py-2 mb-3">
                                    <small><i class="fa fa-language me-1"></i> Editing content in <strong>বাংলা (Bangla)</strong></small>
                                </div>

                                <div class="mb-4">
                                    <label class="form-label fw-semibold">Section Title (বাংলা)</label>
                                    <input type="text" name="section_title_bn" class="form-control" value="{{ old('section_title_bn', $guideline->section_title_bn) }}" placeholder="যেমন: ভর্তি নির্দেশিকা ও ফি কাঠামো">
                                </div>
                                ...
                                <div class="row g-3 mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <textarea id="details_bn" name="details_bn" class="form-control rich-editor" rows="5">{!! old('details_bn', $guideline->details_bn) !!}</textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                        ...
                                        <textarea id="process_bn" name="process_bn" class="form-control rich-editor" rows="5">{!! old('process_bn', $guideline->process_bn) !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row g-3 mb-4">
                                    <div class="col-md-4">
                                        ...
                                        <textarea id="admission_fees_bn" name="admission_fees_bn" class="form-control rich-editor" rows="5">{!! old('admission_fees_bn', $guideline->admission_fees_bn) !!}</textarea>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                        ...
                                        <textarea id="monthly_fees_bn" name="monthly_fees_bn" class="form-control rich-editor" rows="5">{!! old('monthly_fees_bn', $guideline->monthly_fees_bn) !!}</textarea>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                        ...
                                        <textarea id="others_fees_bn" name="others_fees_bn" class="form-control rich-editor" rows="5">{!! old('others_fees_bn', $guideline->others_fees_bn) !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea id="payment_rules_bn" name="payment_rules_bn" class="form-control rich-editor" rows="4">{!! old('payment_rules_bn', $guideline->payment_rules_bn) !!}</textarea>
                                </div>
                                ...
                                <div id="points-container-bn" class="mb-4">
                                    @php $bnPoints = old('points_bn', is_array($guideline->points_bn) ? $guideline->points_bn : []); @endphp
                                    @if(!empty($bnPoints))
                                        @foreach($bnPoints as $index => $point)
                                            <div class="point-row input-group mb-2">
                                                <span class="input-group-text bg-light fw-bold point-index">{{ $index + 1 }}</span>
                                                <input type="text" name="points_bn[]" class="form-control" value="{{ $point }}" placeholder="বাংলায় নির্দেশিকা লিখুন...">
                            ...
                            <div class="tab-pane fade" id="lang-ab" role="tabpanel" aria-labelledby="lang-ab-tab">
                                <div class="alert alert-warning py-2 mb-3">
                                    <small><i class="fa fa-book me-1"></i> Editing content in <strong>العربية (Arabic)</strong></small>
                                </div>

                                <div class="mb-4">
                                    <label class="form-label fw-semibold">Section Title (العربية)</label>
                                    <input type="text" name="section_title_ab" class="form-control" dir="rtl" value="{{ old('section_title_ab', $guideline->section_title_ab) }}" placeholder="مثال: شروط القبول والرسوم الدراسية">
                                </div>
                                ...
                                <div class="row g-3 mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <textarea id="details_ab" name="details_ab" class="form-control rich-editor" dir="rtl" rows="5">{!! old('details_ab', $guideline->details_ab) !!}</textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                        ...
                                        <textarea id="process_ab" name="process_ab" class="form-control rich-editor" dir="rtl" rows="5">{!! old('process_ab', $guideline->process_ab) !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row g-3 mb-4">
                                    <div class="col-md-4">
                                        ...
                                        <textarea id="admission_fees_ab" name="admission_fees_ab" class="form-control rich-editor" dir="rtl" rows="5">{!! old('admission_fees_ab', $guideline->admission_fees_ab) !!}</textarea>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                        ...
                                        <textarea id="monthly_fees_ab" name="monthly_fees_ab" class="form-control rich-editor" dir="rtl" rows="5">{!! old('monthly_fees_ab', $guideline->monthly_fees_ab) !!}</textarea>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                        ...
                                        <textarea id="others_fees_ab" name="others_fees_ab" class="form-control rich-editor" dir="rtl" rows="5">{!! old('others_fees_ab', $guideline->others_fees_ab) !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea id="payment_rules_ab" name="payment_rules_ab" class="form-control rich-editor" dir="rtl" rows="4">{!! old('payment_rules_ab', $guideline->payment_rules_ab) !!}</textarea>
                                </div>
                                ...
                                <div id="points-container-ab" class="mb-4">
                                    @php $abPoints = old('points_ab', is_array($guideline->points_ab) ? $guideline->points_ab : []); @endphp
                                    @if(!empty($abPoints))
                                        @foreach($abPoints as $index => $point)
                                            <div class="point-row input-group mb-2">
                                                <span class="input-group-text bg-light fw-bold point-index">{{ $index + 1 }}</span>
                                                <input type="text" name="points_ab[]" class="form-control" dir="rtl" value="{{ $point }}" placeholder="أدخل التعليمات باللغة العربية...">
                        ...
                        <div class="d-flex align-items-center gap-2 pt-3 border-top">
                            <button type="submit" class="btn btn-primary px-4 py-2 fw-semibold shadow-sm">
                                <i class="fa fa-save me-1"></i> Update Admission Guideline
                            </button>
        ...
        <table style="width: 100%; border-collapse: collapse; text-align: center; font-size: 14px; border: 1.5px solid #222;" dir="rtl">
            ...
            <tfoot>
                <tr style="background-color: #f1f3f5; font-weight: bold; border-top: 1.5px solid #222;">
                    ...
                    <td style="padding: 10px 8px; border: 1px solid #222; font-size: 15px;">٦٥٠٠/=</td>
